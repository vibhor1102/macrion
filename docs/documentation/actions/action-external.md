...
Macrion supports adding strongly-typed extras to the intent payload. The engine supports 8 primitive data types via [`putDomainExtra`](file:///home/vibhor/Scripts/Macrion-worktrees/Macrion-Antigravity/core/smart/domain/src/main/java/io/github/vibhor1102/macrion/core/domain/model/action/intent/IntentExtra.kt#L63):
...
Notifications are categorized into three dedicated Android notification channels managed by [`NotificationRequestExecutor`](file:///home/vibhor/Scripts/Macrion-worktrees/Macrion-Antigravity/core/common/actions/src/main/java/io/github/vibhor1102/macrion/core/common/actions/notification/NotificationRequestExecutor.kt):
...
1. **Macrion Dispatch**: When `ExternalAction` fires, it broadcasts `com.twofortyfouram.locale.intent.action.REQUEST_QUERY` via [`ExternalActionEventContract`](file:///home/vibhor/Scripts/Macrion-worktrees/Macrion-Antigravity/core/common/actions/src/main/java/io/github/vibhor1102/macrion/core/common/actions/external/ExternalActionEventContract.kt).
