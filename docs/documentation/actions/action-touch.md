...
- **`OR` Logic**: When an event evaluates with `OR` logic, multiple conditions may be checked. Macrion automatically selects the first condition that matched in the frame via [`getFirstScreenConditionDetectedResult()`](file:///home/vibhor/Scripts/Macrion-worktrees/Macrion-Antigravity/core/smart/processing/src/main/java/io/github/vibhor1102/macrion/core/processing/data/processor/ActionExecutor.kt#L138).
...
Macrion's [`ScalingManager`](file:///home/vibhor/Scripts/Macrion-worktrees/Macrion-Antigravity/core/base/src/main/java/io/github/vibhor1102/macrion/core/base/scaling/ScalingManager.kt) ensures pixel-perfect touch mapping:
