...
Macrion incorporates an integrated debugging engine ([`DebugEngine`](file:///home/vibhor/Scripts/Macrion-worktrees/Macrion-Antigravity/core/smart/debugging/src/main/java/io/github/vibhor1102/macrion/core/smart/debugging/engine/DebugEngine.kt)) that provides real-time visual overlays, per-condition latency profiling, and comprehensive execution event logs.
...
[`ConditionProfileRecorder`](file:///home/vibhor/Scripts/Macrion-worktrees/Macrion-Antigravity/core/smart/debugging/src/main/java/io/github/vibhor1102/macrion/core/smart/debugging/engine/recorder/ConditionProfileRecorder.kt) benchmarks every condition evaluation in real time, recording:
...
Whenever an event triggers, Macrion records a detailed snapshot ([`DebugReportEventOccurrence`](file:///home/vibhor/Scripts/Macrion-worktrees/Macrion-Antigravity/core/smart/debugging/src/main/java/io/github/vibhor1102/macrion/core/smart/debugging/domain/model/report/DebugReportEventOccurrence.kt)) capturing the exact internal state of your scenario at that instant.
...
For persistent issues or unexpected crashes, Macrion includes a built-in diagnostic dumping subsystem implemented via the [`Dumpable`](file:///home/vibhor/Scripts/Macrion-worktrees/Macrion-Antigravity/core/base/src/main/java/io/github/vibhor1102/macrion/core/base/Dumpable.kt) interface.
