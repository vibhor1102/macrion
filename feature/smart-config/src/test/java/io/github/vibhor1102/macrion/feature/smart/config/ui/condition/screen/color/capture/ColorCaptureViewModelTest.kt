...
class ColorCaptureViewModelTest {
    ...
    @Test
    fun captureScreen_usesCenterOfDisplay() = runTest(testDispatcher) {
    ...
    @Test
    fun getPixelSelection_returnsCenteredPositionAndColor_inPixelSelectionState() = runTest(testDispatcher) {
        ...
        assertEquals(PointF(540f, 960f), result!!.first)
